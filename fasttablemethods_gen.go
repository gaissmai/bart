...
//
// The bulk table load could be done with [Fast.Insert] and then you can
// use [Fast.InsertPersist], [Fast.ModifyPersist] and
// [Fast.DeletePersist] for further lock-free ops.
...
func (t *Fast[V]) Delete(pfx netip.Prefix) (val V, exists bool) {
	if !pfx.IsValid() {
		return val, exists
	}
...
// typically taking μsec instead of nsec.
func (t *Fast[V]) DeletePersist(pfx netip.Prefix) (pt *Fast[V], val V, found bool) {
	if !pfx.IsValid() {
		return t, val, false
	}
...
// Example:
//
//	pt := t.WalkPersist(func(pt *Fast[int], pfx netip.Prefix, val int) (*Fast[int], bool) {
//		switch {
...
//		return pt, true
//	})
func (t *Fast[V]) WalkPersist(fn func(*Fast[V], netip.Prefix, V) (*Fast[V], bool)) *Fast[V] {
...
func (t *Fast[V]) ModifyPersist(pfx netip.Prefix, cb func(_ V, ok bool) (_ V, del bool)) (pt *Fast[V], _ V, deleted bool) {
	var zero V
	if !pfx.IsValid() {
		return t, zero, false
	}
