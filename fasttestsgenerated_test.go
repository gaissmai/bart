...
func (t *Fast[V]) flatSorted() golden.TableSlice[V] {
...
func TestTableNilArguments_Fast(t *testing.T) {
	t.Parallel()
...
func TestZonedLookup_Fast(t *testing.T) {
	t.Parallel()

	check := func(t *testing.T, table *Fast[string], ip netip.Addr, want string, wantOK bool) {
		t.Helper()
