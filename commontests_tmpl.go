...
func TestZonedLookup__TABLE_TYPE(t *testing.T) {
	t.Parallel()

	check := func(t *testing.T, table *_TABLE_TYPE[string], ip netip.Addr, want string, wantOK bool) {
		t.Helper()
