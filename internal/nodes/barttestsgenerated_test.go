...
// TestEqualRec_BartNode tests the recursive node equality comparison.
func TestEqualRec_BartNode(t *testing.T) {
	t.Parallel()

	// nil checks
	var nilNode1, nilNode2 *BartNode[int]
...
// TestOverlapsExtra_BartNode tests specific edge cases in trie overlap detection.
func TestOverlapsExtra_BartNode(t *testing.T) {
	t.Parallel()
...
// TestDumpStringExtra_BartNode tests type classification in DumpString and DumpRec.
func TestDumpStringExtra_BartNode(t *testing.T) {
	t.Parallel()
...
// TestDeletePurgeExtra_BartNode tests the bottom-up trie compression on delete.
func TestDeletePurgeExtra_BartNode(t *testing.T) {
	t.Parallel()
...
// TestUnionRecExtra_BartNode tests specific edge cases in trie Union operations.
func TestUnionRecExtra_BartNode(t *testing.T) {
	t.Parallel()

	_, isLite := any(new(BartNode[int])).(*LiteNode[int])
...
// TestSubnetsEarlyExit_BartNode tests early termination in Subnets traversal.
func TestSubnetsEarlyExit_BartNode(t *testing.T) {
	t.Parallel()
...
// TestSupernetsExtra_BartNode tests specific edge cases and early exits in Supernets traversal.
func TestSupernetsExtra_BartNode(t *testing.T) {
	t.Parallel()
