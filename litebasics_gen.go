...
func (n *liteNode[V]) delete(pfx netip.Prefix) (val V, exists bool) {
...
func (n *liteNode[V]) modify(pfx netip.Prefix, cb func(val V, found bool) (_ V, del bool)) (delta int, _ V, deleted bool) {
	var zero V
...
func (n *liteNode[V]) modifyPersist(cloneFn cloneFunc[V], pfx netip.Prefix, cb func(val V, found bool) (_ V, del bool)) (delta int, _ V, deleted bool) {
	var zero V
