...
func TestBoundaryBehavior_DefaultRoutes(t *testing.T) {
	...
	genTables := []struct {
		name    string
		builder func() tabler[*routeEntry]
	}{
		{
			name:    "Table",
			builder: func() tabler[*routeEntry] { return &Table[*routeEntry]{} },
		},
		{
			name:    "Fast",
	...
	for _, genTbl := range genTables {
		for _, tc := range testCases {
			t.Run(genTbl.name+"_"+tc.name, func(t *testing.T) {
				t.Parallel()
...
func TestBoundaryBehavior_TransitionPaths(t *testing.T) {
	...
	for _, genTbl := range genTables {
		t.Run(genTbl.name+"_"+"IPv4_Transitions", func(t *testing.T) {
			t.Parallel()
		...
		t.Run(genTbl.name+"_"+"IPv6_Transitions", func(t *testing.T) {
			t.Parallel()
			tbl := genTbl.builder()
...
func TestBoundaryBehavior_MixedPrefixLengths(t *testing.T) {
	...
	for _, genTbl := range genTables {
		t.Run(genTbl.name, func(t *testing.T) {
			t.Parallel()
